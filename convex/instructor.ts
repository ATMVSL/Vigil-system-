...
export const submitReview = mutation({
  args: {
    ...
    type: v.union(
      v.literal("practical"), v.literal("simulation"), v.literal("peer_support"),
      v.literal("certification_review"), v.literal("general")
    ),
    grade: v.union(v.literal("pass"), v.literal("fail"), v.literal("merit"), v.literal("distinction")),
    feedback: v.string(),
  },
...
export const createLesson = mutation({
  args: {
    ...
    content: v.string(),
    type: v.union(
      v.literal("lecture"), v.literal("lab"), v.literal("assessment"),
      v.literal("simulation"), v.literal("practical")
    ),
    order: v.number(),
...
export const createCourse = mutation({
  args: {
    ...
    category: v.union(
      v.literal("self_doctrine"), v.literal("mirror_operations"), v.literal("cognitive_loop"),
      v.literal("sql_training"), v.literal("infrastructure"), v.literal("certification"),
      v.literal("peer_support"), v.literal("continuing_education")
    ),
