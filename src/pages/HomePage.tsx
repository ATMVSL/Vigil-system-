    ...
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Veteran Identity Garrison for Intentional Living — Your platform, your
          presence, your continuity.
        </p>
        ...
        <CardContent className="py-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
            {[
              ...
              <div
                key={p.word}
                className="text-center p-2 rounded-md bg-background/50 border border-border/30"
              >
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {[
              ...
              <div
                key={p}
                className="text-center p-2 rounded-md border border-border/30 bg-background/30"
              >
