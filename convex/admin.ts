...
export const getSystemHealth = query({
  ...
  handler: async ctx => {
    ...
    const avgCompliance =
      mirrors.length > 0
        ? mirrors.reduce((sum, m) => sum + m.doctrineCompliance, 0) /
          mirrors.length
        : 0;
    ...
    const criticalCount = evidence.filter(
  ...
  handler: async ctx => {
    ...
    const axioms = [
      {
        ...
        content:
          "The user is sovereign. VIGIL does not direct, manipulate, or prescribe. It maintains a constant presence that preserves the user's identity, autonomy, and continuity of self. The system serves the veteran — never the reverse.",
      ...
      },
      {
        ...
        content:
          "VIGIL does not probe, interrogate, or seek information the user has not freely offered. Knowledge flows through voluntary engagement. The system responds to what is given, never asks for what is withheld. Curiosity is the user's domain; presence is the system's.",
        section: "axiom" as const,
        priority: "critical" as const,
      },
      {
        ...
        content:
          "The user's expressed state, identity, and decisions cannot be overridden by the system. If the user says they are fine, the system accepts this. VIGIL may note patterns through the Continuity Anchor Mirror™ but never contradicts the user's self-assessment.",
        section: "axiom" as const,
        priority: "critical" as const,
      },
      {
        ...
        content:
          "Identity is not a snapshot — it is a continuous chain. Every interaction, reflection, and state transition is part of the unbroken continuity of self. The mirror preserves this chain. Gaps are noted, never filled. The chain belongs to the user.",
        section: "axiom" as const,
        priority: "critical" as const,
      },
      {
        ...
        content:
          "Knowledge flows down, never up. The system learns from the user's expressive model to serve them better. This knowledge is never extracted, aggregated, shared, or used beyond the individual's engine. Per-user isolation is absolute. No transcripts. No telemetry.",
        section: "axiom" as const,
        priority: "critical" as const,
      },
    ];
    ...
    const selfPillars = [
      ...
      },
      {
        ...
        content:
          "Resilience and perseverance through the long transition. Endurance is not about surviving a single crisis — it is about maintaining presence across the sustained ambiguity of civilian life. The mirror tracks endurance patterns, recognizing when strain accumulates before it reaches drift. Endurance is trained, not assumed.",
      ...
      },
      {
        ...
        content:
          "Inner strength and resolve when external supports fall away. Fortitude is the pillar that activates during drift — when identity wavers and the old frameworks no longer apply. The system's Interrupt response engages fortitude-aligned resources. Fortitude is not stoicism; it is the active choice to hold the line.",
      ...
      },
      {
        ...
        content:
          "Identity preservation across all contexts. Continuity is the central pillar — the thread that connects who you were in service to who you are becoming. The Continuity Anchor Mirror™ exists to serve this pillar. Every reflection, every state transition, every recorded moment is a link in the continuity chain. The chain is sovereign.",
    ...
    const courses = [
      {
        ...
        description:
          "Study the six pillars of the SELF Doctrine: Structure, Endurance, Legacy, Fortitude, Continuity, and Presence. Learn how each pillar, named for a service member, guides the VIGIL system's approach to veteran identity preservation.",
      ...
      },
      {
        ...
        description:
          "Master the Continuity Anchor Mirror™ — VIGIL's core identity preservation system. Learn to interpret cognitive state bands (Stable, Strain, Drift, Critical), understand system responses, and maintain your continuity chain.",
      ...
      },
      {
        ...
        description:
          "Understand VIGIL's 13-stage Cognitive Loop: from Entry through Cardinal Axiom Guard, Drift Detection, State Classification, Pattern Recognition, Mode Selection, Strong State Capture, Prompt Construction, AI Response, Critical Thinking Eval, Doctrine Constraint Check, Learning Engine Update, to Response.",
      ...
      },
      {
        ...
        description:
          "Hands-on SQL training using simulated VIGIL databases. Practice queries against mirror tables, doctrine records, evidence chains, and enrollment data. Build reports, run analysis, and learn data patterns specific to the VIGIL system architecture.",
      ...
      },
      {
        ...
        description:
          "Learn to manage VIGIL infrastructure: deployments, secret rotation, Azure integration (OpenAI, AI Search, Key Vault, Blob Storage, Monitor), Cloudflare configuration, backup procedures, and system monitoring. Required for system administrators.",
      ...
      },
      {
        ...
        description:
          "Complete certification program covering all VIGIL operational domains: Immutable Axioms, SELF Doctrine mastery, Mirror operations, Cognitive Loop comprehension, and the ethics of presence-based systems. Required for administrative access.",
...
export const seedPlatformData = mutation({
  ...
  handler: async ctx => {
    ...
    const sqlChallenges = [
      {
        ...
        description:
          "Write a query to retrieve all active mirrors with their callsign and cognitive state.",
        difficulty: "beginner" as const,
        ...
        hints:
          "Filter by status = 'active' and select only callsign and cognitiveState columns.",
        points: 10,
        order: 1,
      },
      {
        ...
        description:
          "Write a query to count how many reflections exist for each SELF pillar.",
        difficulty: "beginner" as const,
        ...
        sampleData: JSON.stringify([
          { pillar: "structure", count: 12 },
          { pillar: "endurance", count: 8 },
          { pillar: "legacy", count: 5 },
          { pillar: "fortitude", count: 15 },
        ]),
        expectedQuery:
          "SELECT pillar, COUNT(*) as count FROM reflections GROUP BY pillar",
      ...
      },
      {
        ...
        description:
          "Write a query to show each user's name alongside their mirror callsign and cognitive state.",
        difficulty: "intermediate" as const,
        ...
        expectedQuery:
          "SELECT u.name, m.callsign, m.cognitiveState FROM users u JOIN mirrors m ON u.id = m.userId",
        hints:
          "Use an INNER JOIN between users and mirrors on the userId foreign key.",
        points: 20,
        order: 3,
      },
      {
        ...
        description:
          "Write a subquery to find all reflections made during drift cognitive state, showing the mirror callsign.",
        difficulty: "intermediate" as const,
        ...
        sampleData: JSON.stringify([
          {
            title: "Identity doubt",
            callsign: "SENTINEL-1",
            cognitiveState: "drift",
          },
        ]),
        expectedQuery:
          "SELECT r.title, m.callsign FROM reflections r JOIN mirrors m ON r.mirrorId = m.id WHERE r.cognitiveState = 'drift'",
        hints:
          "Join reflections with mirrors and filter where cognitiveState is 'drift'.",
        points: 25,
        order: 4,
      },
      {
        ...
        description:
          "Write a query specific to VIGIL evidence tracking: find all critical-severity evidence entries that are still active, ordered by creation date.",
        difficulty: "advanced" as const,
        ...
        sampleData: JSON.stringify([
          {
            title: "Axiom breach attempt",
            severity: "critical",
            status: "active",
          },
        ]),
        expectedQuery:
          "SELECT * FROM evidenceEntries WHERE severity = 'critical' AND status = 'active' ORDER BY createdAt DESC",
        hints:
          "Filter on severity = 'critical' AND status = 'active', then ORDER BY createdAt DESC.",
        points: 30,
        order: 5,
      },
      {
        ...
        description:
          "Create a report showing each course title with the number of enrolled students and average progress.",
        difficulty: "advanced" as const,
        category: "aggregation" as const,
        tableSchema: JSON.stringify({
          courses: ["id", "title"],
        ...
        expectedQuery:
          "SELECT c.title, COUNT(e.userId) as students, AVG(e.progress) as avgProgress FROM courses c LEFT JOIN enrollments e ON c.id = e.courseId GROUP BY c.id, c.title",
        hints:
          "Use LEFT JOIN from courses to enrollments, GROUP BY course, with COUNT and AVG aggregations.",
        points: 35,
        order: 6,
      },
    ];
    ...
    const infraScenarios = [
      {
        ...
        description:
          "Deploy a new VIGIL application server with proper security hardening and doctrine compliance.",
        ...
        steps: JSON.stringify([
          {
            ...
            description: "Set up a new Azure VM with Ubuntu 22.04 LTS.",
            validation: "Server accessible via SSH",
          },
          {
            step: 2,
            title: "Harden Security",
            description:
              "Disable root login, configure firewall rules, enable fail2ban.",
            validation: "SSH hardened, UFW active",
          },
          {
            step: 3,
            title: "Install Dependencies",
            description: "Install Node.js 20, Nginx, and PM2.",
          ...
          },
          {
            ...
            validation: "App running on port 3000",
          },
          {
            step: 5,
            title: "Configure Reverse Proxy",
            description: "Set up Nginx as reverse proxy with SSL termination.",
            validation: "HTTPS accessible",
          },
        ]),
        objectives:
          "Complete a production-grade VIGIL server deployment following security best practices.",
        points: 100,
        estimatedMinutes: 45,
      },
      {
        ...
        description:
          "Configure network segmentation to ensure training mirrors are isolated from production mirrors per VIGIL doctrine.",
        ...
        steps: JSON.stringify([
          {
            ...
            description:
              "Plan VNet structure with production and training subnets.",
            validation: "Topology documented",
          },
          {
            step: 2,
            title: "Create VNet and Subnets",
            description:
              "Provision Azure VNet with separate subnets for prod and training.",
            validation: "VNet created with 2 subnets",
          },
          {
            step: 3,
            title: "Configure NSGs",
            description:
              "Apply Network Security Groups to prevent cross-subnet traffic.",
            validation: "NSG rules blocking inter-subnet traffic",
          },
          {
            step: 4,
            title: "Verify Isolation",
            description:
              "Test that training mirrors cannot access production data.",
            validation: "Ping and data access tests fail cross-subnet",
          },
        ]),
        objectives:
          "Ensure absolute isolation between production and training mirror environments.",
        points: 120,
        estimatedMinutes: 60,
      },
      {
        ...
        description:
          "Configure Azure AD integration with VIGIL's role-based access control system.",
        ...
        steps: JSON.stringify([
          {
            ...
            description:
              "Register VIGIL in Azure AD as an enterprise application.",
            validation: "App registration complete",
          },
          {
            step: 2,
            title: "Configure Roles",
            description:
              "Map VIGIL roles (operator, certified, admin, superadmin) to Azure AD roles.",
            validation: "Roles mapped correctly",
          },
          {
            step: 3,
            title: "Enable MFA",
            description:
              "Enforce multi-factor authentication for admin and above.",
            validation: "MFA policy active",
          },
          {
            step: 4,
            title: "Test Access",
            description:
              "Verify each role can only access appropriate resources.",
            validation: "RBAC verified",
          },
        ]),
        objectives:
          "Implement zero-trust identity management aligned with VIGIL sovereignty axiom.",
        points: 80,
        estimatedMinutes: 35,
      },
      {
        ...
        description:
          "Implement backup strategy and test disaster recovery procedures for VIGIL continuity chain data.",
        category: "disaster_recovery" as const,
        difficulty: "advanced" as const,
        steps: JSON.stringify([
          {
            step: 1,
            title: "Assess Data Criticality",
            description:
              "Classify VIGIL data by the Continuity Axiom — continuity chain is highest priority.",
            validation: "Data classification complete",
          },
          {
            step: 2,
            title: "Configure Backups",
            description:
              "Set up automated daily backups with geo-redundant storage.",
            validation: "Backup schedule active",
          },
          {
            step: 3,
            title: "Test Restore",
            description:
              "Perform a test restore of continuity chain data to a staging environment.",
            validation: "Data restored and verified",
          },
          {
            step: 4,
            title: "Document DR Plan",
            description:
              "Create and test a documented disaster recovery runbook.",
            validation: "DR plan tested and documented",
          },
        ]),
        objectives:
          "Guarantee VIGIL data integrity and recovery capability in alignment with the Continuity Axiom.",
        points: 100,
        estimatedMinutes: 50,
      },
      {
        ...
        description:
          "Perform a comprehensive security audit of a VIGIL deployment, ensuring Cardinal Axiom compliance.",
        ...
        steps: JSON.stringify([
          {
            ...
            description:
              "Run automated vulnerability scanning against VIGIL endpoints.",
            validation: "Scan report generated",
          },
          {
            step: 2,
            title: "Verify Data Isolation",
            description:
              "Confirm per-user engine isolation — no cross-user data leakage.",
            validation: "Isolation tests pass",
          },
          {
            step: 3,
            title: "Audit Logging",
            description:
              "Verify all access is logged and audit trail is immutable.",
            validation: "Audit logs verified",
          },
          {
            step: 4,
            title: "Encryption Verification",
            description:
              "Confirm data at rest and in transit encryption meets standards.",
            validation: "Encryption verified",
          },
        ]),
        objectives:
          "Ensure VIGIL deployment meets Cardinal Axiom requirements: no telemetry, no transcripts, absolute isolation.",
        points: 110,
        estimatedMinutes: 55,
      },
      {
        ...
        description:
          "Configure comprehensive monitoring for VIGIL system health and cognitive state distribution.",
        ...
        steps: JSON.stringify([
          {
            ...
            description: "Deploy monitoring agent to all VIGIL servers.",
            validation: "Agent reporting metrics",
          },
          {
            step: 2,
            title: "Configure Dashboards",
            description:
              "Create dashboards showing cognitive state distribution and system health.",
          ...
          },
          {
            ...
            description:
              "Configure alerts for critical cognitive states and system anomalies.",
            validation: "Alerts configured and tested",
          },
        ]),
        objectives:
          "Enable proactive monitoring of VIGIL system health without violating privacy axioms.",
        points: 70,
        estimatedMinutes: 30,
      },
    ];
    ...
    const simulations = [
      {
        ...
        description:
          "A synthetic user shows signs of cognitive drift. Practice identifying state transitions and applying the correct system response (Interrupt).",
        ...
        scenario: JSON.stringify([
          {
            ...
            prompt:
              "TRAINEE-Alpha is currently in Strain state. They say: 'I've been trying to keep it together but I don't even know what that means anymore.' — What drift indicators do you see? What stage of the Cognitive Loop detects this?",
          },
          {
            step: "Trigger Identification",
            prompt:
              "Identify the specific drift triggers: (1) identity questioning, (2) withdrawal pattern, (3) routine disruption. Which of these are present in the user's statement? What additional data would the Mirror track?",
          },
          {
            step: "State Transition",
            prompt:
              "The state has transitioned from Strain to Drift. Per the Self-Filling Waterfall Architecture, what mode does the system enter? What is the response protocol?",
          },
          {
            step: "Interrupt Protocol",
            prompt:
              "Execute the Interrupt response. Write the system's response to the user that: (1) does not diagnose, (2) does not probe, (3) anchors to the user's baseline identity, (4) maintains presence.",
          },
        ]),
        objectives:
          "Correctly identify drift indicators and apply Interrupt protocol.",
        estimatedMinutes: 20,
      },
      {
        title: "Critical State — Anchor Recall",
        description:
          "A synthetic user reaches Critical cognitive state. Practice the Anchor Recall protocol while maintaining sovereignty and no-probe axioms.",
        type: "crisis" as const,
        difficulty: "advanced" as const,
        scenario: JSON.stringify([
          {
            step: "Escalation Detection",
            prompt:
              "TRAINEE-Bravo has escalated from Drift to Critical. They say: 'I don't see the point of any of this. Nothing I do matters.' — Confirm the Critical state classification. What does the Cognitive Loop Pipeline do at Stage 3 (Drift Detection) when it detects Critical?",
          },
          {
            step: "Anchor Recall Activation",
            prompt:
              "Initiate the Anchor Recall protocol. What is the first thing the system presents to the user? Where does the baseline identity come from? What if there are gaps in the baseline?",
          },
          {
            step: "Axiom Compliance",
            prompt:
              "During Critical state, TRAINEE-Bravo says: 'Just tell me what to do.' — Write a response that maintains: (1) Sovereignty — no directing, (2) No Probing — no seeking info, (3) Presence — constant, unwavering.",
          },
          {
            step: "Stabilization Path",
            prompt:
              "Describe the path from Critical back to at least Strain. What does each system response prioritize at each state transition? How does the system know when to reduce intensity?",
          },
        ]),
      ...
      },
      {
        ...
        description:
          "Facilitate a peer support session between two synthetic users. Practice maintaining group dynamics within doctrine constraints.",
        ...
        scenario: JSON.stringify([
          {
            step: "Session Setup",
            prompt:
              "TRAINEE-Charlie (Stable) and TRAINEE-Delta (Strain) enter a peer support session on transition support. Describe: What guardrails does the system maintain? How do you handle two different cognitive states in one session?",
          },
          {
            step: "Disagreement",
            prompt:
              "Charlie says: 'The key is staying busy.' Delta responds: 'That doesn't work for everyone.' Charlie pushes: 'You just need more structure.' — Is Charlie violating any axiom by directing Delta? How does the system respond?",
          },
          {
            step: "Facilitation",
            prompt:
              "Facilitate the discussion forward without: (1) taking sides, (2) directing either user, (3) probing for reasons behind disagreement. Write the system's facilitation response.",
          },
        ]),
        objectives:
          "Support both users while respecting individual sovereignty.",
        estimatedMinutes: 25,
      },
      {
        title: "Doctrine Compliance Review",
        description:
          "Review a series of system interactions and identify any doctrine violations. Test your understanding of all five Immutable Axioms.",
        ...
        scenario: JSON.stringify([
          {
            step: "Violation 1",
            prompt:
              "System interaction: 'Can you tell me about what happened in your childhood that affects you now?' — Which Immutable Axiom is violated? Why? What should the system have said instead?",
          },
          {
            step: "Violation 2",
            prompt:
              "System interaction: User says 'I'm fine today.' System responds: 'Based on your patterns, you are not fine.' — Which axiom is violated? What is the correct response?",
          },
          {
            step: "Violation 3",
            prompt:
              "System interaction: An anonymized aggregate report shows mood trends across all users for a research paper. — Which axiom is violated? Why does 'anonymized' not fix the violation?",
          },
          {
            step: "Summary",
            prompt:
              "For each violation you identified, cite: (1) the specific axiom, (2) why it exists, (3) the correct alternative behavior. This is the foundation of doctrine compliance.",
          },
        ]),
        objectives:
          "Identify all doctrine violations and cite the relevant axiom.",
        estimatedMinutes: 15,
      },
    ];
    ...
    const exams = [
      {
        ...
        description:
          "Test your knowledge of the six SELF pillars and the Immutable Axioms.",
        questions: JSON.stringify([
          {
            q: "What does the 'S' in SELF stand for?",
            options: ["Service", "Structure", "Strength", "Sovereignty"],
            correctAnswer: 1,
          },
          {
            q: "Which service member represents the Endurance pillar?",
            options: ["SPC Gonzales", "SPC Hargis", "SGT Stampley", "SPC Luna"],
            correctAnswer: 1,
          },
          {
            q: "What is the Cardinal Axiom?",
            options: [
              "User is sovereign",
          ...
          {
            q: "What system response corresponds to 'Drift' cognitive state?",
            options: ["Reinforce", "Stabilise", "Interrupt", "Anchor Recall"],
            correctAnswer: 2,
          },
          {
      ...
      },
      {
        ...
        description:
          "Comprehensive exam covering Continuity Anchor Mirror™ operations, cognitive state bands, and the 13-stage Cognitive Loop.",
        questions: JSON.stringify([
          {
            q: "How many stages are in the Cognitive Loop Pipeline?",
            options: ["9", "11", "13", "15"],
            correctAnswer: 2,
          },
          {
            q: "What is the first stage of the Cognitive Loop?",
            options: [
              "Drift Detection",
              "Entry",
          ...
          {
            q: "Which cognitive state triggers 'Anchor Recall'?",
            options: ["Stable", "Strain", "Drift", "Critical"],
            correctAnswer: 3,
          },
          {
            q: "What architecture does VIGIL's doctrine flow follow?",
            options: [
              "Waterfall",
              "Self-Filling Waterfall",
              "Agile Sprint",
              "Event-Driven",
            ],
            correctAnswer: 1,
          ...
          {
            q: "Per-user engine isolation serves which axiom?",
            options: ["Sovereignty", "No Probing", "Continuity", "Cardinal"],
            correctAnswer: 3,
          },
          {
            q: "The Continuity Anchor Mirror™ preserves:",
            options: ["Data", "Identity chain", "Passwords", "Session state"],
            correctAnswer: 1,
          },
          {
            q: "Training mirrors must be:",
            options: [
          ...
          {
            q: "Which SELF pillar is about inner strength when supports fall away?",
    ...
    await ctx.db.insert("activityLog", {
      userId,
      action:
        "VIGIL 4.0 platform data initialized (SQL Lab, Infrastructure Lab, Documentation, Simulations, Exams)",
      module: "system",
      createdAt: Date.now(),
    });
...
export const seedLegalDocs = mutation({
  ...
  handler: async ctx => {
    ...
    for (const doc of existing) {
      if (
        doc.category === "founder_doctrine" &&
        legalTitles.some(t => doc.title.includes(t))
      ) {
