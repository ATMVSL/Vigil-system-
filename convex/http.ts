...
http.route({
  ...
  handler: httpAction(async (_ctx, request) => {
    ...
    const { content, cognitiveState, callsign, recentReflections, voiceMode, userContext } = body;
    ...
    const systemPrompt = buildMirrorSystemPrompt(cognitiveState, callsign, voiceMode ?? false, userContext);
